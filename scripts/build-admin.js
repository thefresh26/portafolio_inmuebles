...
<style>
  ...
  *{box-sizing:border-box;}
  ...
  body{
    background-image:
      radial-gradient(ellipse 620px 480px at -6% 12%, rgba(245,166,35,0.24) 0%, rgba(245,166,35,0) 62%),
      radial-gradient(ellipse 560px 460px at 106% 30%, rgba(26,168,221,0.26) 0%, rgba(26,168,221,0) 60%),
      radial-gradient(ellipse 520px 420px at -4% 82%, rgba(26,168,221,0.18) 0%, rgba(26,168,221,0) 60%),
      radial-gradient(ellipse 480px 400px at 104% 88%, rgba(245,166,35,0.16) 0%, rgba(245,166,35,0) 60%);
