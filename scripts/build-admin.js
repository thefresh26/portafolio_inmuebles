...
<style>
  ...
  *{box-sizing:border-box;}
  ...
  .countdown-clock{ position:relative; z-index:1; display:flex; align-items:center; gap:14px; }
  .countdown-box{
    background:rgba(234,241,251,0.06); border:1px solid rgba(234,241,251,0.12);
    border-radius:10px; padding:12px 20px; text-align:center; min-width:68px;
  }
  .countdown-num{ display:block; font-size:28px; font-weight:800; font-variant-numeric:tabular-nums; color:var(--manila); }
  .countdown-label{ display:block; font-size:9.5px; font-weight:700; text-transform:uppercase; letter-spacing:0.05em; color:rgba(234,241,251,0.62); margin-top:3px; }
