...
<style>
  ...
  *{box-sizing:border-box;}
  ...
  .hero-row{
    ...
    gap:24px 40px; max-width:1200px; margin:0 auto; padding:40px 24px 28px;
  }
  .hero{ padding:0; max-width:640px; }
  .hero .eyebrow{
  ...
  .countdown-banner{
    ...
    border-radius:14px;
    background:
      radial-gradient(ellipse 260px 160px at 10% 0%, rgba(245,166,35,0.16) 0%, rgba(245,166,35,0) 60%),
      radial-gradient(ellipse 260px 180px at 100% 100%, rgba(26,168,221,0.18) 0%, rgba(26,168,221,0) 60%),
  ...
  .countdown-date{
    position:relative; z-index:1; display:flex; align-items:center; gap:7px; color:var(--sello);
    font-size:10.5px; font-weight:700; text-transform:uppercase; letter-spacing:0.05em; margin-bottom:10px; white-space:nowrap;
  }
  .countdown-dot{ width:6px; height:6px; border-radius:999px; background:var(--sello); flex-shrink:0; animation:dotBlink 1.6s ease-in-out infinite; }
  ...
  .countdown-box{
    ...
    border-radius:8px; padding:8px 11px; text-align:center; min-width:44px;
  }
  .countdown-num{ display:block; font-size:18px; font-weight:800; font-variant-numeric:tabular-nums; color:var(--manila); }
  .countdown-label{ display:block; font-size:7.5px; font-weight:700; text-transform:uppercase; letter-spacing:0.04em; color:rgba(234,241,251,0.6); margin-top:3px; }
  .countdown-sep{ font-size:14px; font-weight:800; color:rgba(234,241,251,0.22); }
  @media (max-width:760px){
    .hero-row{ align-items:flex-start; }
    .countdown-banner{ width:100%; }
    .countdown-clock{ justify-content:space-between; }
  }
  @media (max-width:480px){
