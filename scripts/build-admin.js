...
<style>
  ...
  *{box-sizing:border-box;}
  ...
  /* Fondo "Aurora suave": lavado diagonal muy tenue, azul arriba-izquierda
     y ambar abajo-derecha, sin manchas ni formas duras. */
  body{
    background-image:
      radial-gradient(ellipse 1100px 850px at 0% 0%, rgba(26,168,221,0.24) 0%, rgba(26,168,221,0) 60%),
      radial-gradient(ellipse 1100px 850px at 100% 100%, rgba(245,166,35,0.22) 0%, rgba(245,166,35,0) 60%),
      radial-gradient(ellipse 900px 700px at 100% 0%, rgba(11,42,74,0.05) 0%, rgba(11,42,74,0) 55%);
  ...
  .hero p{
    color:rgba(11,42,74,0.65); font-size:14px; max-width:640px; line-height:1.6;
  ...
  footer{
    padding:24px; text-align:center; font-size:12px; color:rgba(11,42,74,0.45);
