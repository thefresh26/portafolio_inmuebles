...
<style>
  ...
  *{box-sizing:border-box;}
  ...
  footer{
    padding:24px; text-align:center; font-size:12px; color:rgba(234,241,251,0.45);
  ...
  .main-col .grid{ padding:0 0 40px; }
  ...
  .stat-card-head{ display:flex; align-items:center; gap:7px; margin-bottom:2px; }
  .stat-dot{
  ...
  .stat-title{
    ...
    color:rgba(234,241,251,0.5); margin-bottom:10px;
  }
  .stat-card-head .stat-title{ margin-bottom:0; }
  .stat-big{ font-size:30px; font-weight:800; color:var(--manila); font-variant-numeric:tabular-nums; margin:2px 0 2px; }
  .stat-sub{ font-size:12px; color:rgba(234,241,251,0.5); line-height:1.5; }
  ...
  .stat-list .meta{ color:rgba(234,241,251,0.45); font-size:10.5px; white-space:nowrap; }
  .stat-list .val{ color:var(--oro); font-weight:700; font-variant-numeric:tabular-nums; white-space:nowrap; }
  .stat-empty{ color:rgba(234,241,251,0.4); font-size:12.5px; font-style:italic; }
  .stat-footnote{
    margin-top:10px; padding-top:10px; border-top:1px solid rgba(234,241,251,0.08);
    font-size:11px; color:rgba(234,241,251,0.45);
  }
...
const TEMPLATE_TAIL = `  </div>
  ...
  <aside class="stats-sidebar" id="statsSidebar" aria-label="Estadísticas en vivo">
    <div class="stat-card" id="statLive">
    ...
    <div class="stat-card">
      ...
      <ul class="stat-list" id="listJugadores">
        <li class="stat-empty">Cargando…</li>
      </ul>
    </div>
